        ...
        <div className="flex flex-col sm:flex-row items-center gap-5 sm:gap-10">
          ...
          <div className="text-start flex-1">
            ...
            <p className="text-start *:mt-6 max-w-3xl text-base mt-3 leading-6 text-gray-300">
              ...
              expedita at! Quis quidem sint odit vitae laboriosam? Tempore
              dolore doloremque quidem et enim totam ut qui. Atque consequuntur
              perferendis, modi nisi quod aut cupiditate laudantium aperiam
              eligendi dolore aliquam harum, velit rerum laborum consectetur ut
              eos fugit excepturi repellendus quo.
            </p>
          </div>
        </div>
