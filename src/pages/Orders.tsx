      ...
      {loading ? (
        ...
        <div className="max-w-5xl mx-auto ">
          ...
          <p className="text-sm max-w-[600px] tracking-wide text-gray-500">
            ...
            doloremque officia perspiciatis hic quibusdam! Consectetur,
            obcaecati, minus possimus odit officiis repudiandae unde ipsum
            laboriosam impedit illum molestias eaque nihil perferendis!
          </p>
                          ...
                          <div className="flex flex-col gap-2 bg-[#f4f4f480] p-5 border border-gray-200">
                            ...
                            {order?.orderItems?.map((item: ProductProps) => (
                              ...
                              >
                                <Link
                                  to={`/product/${item?._id}`}
                                  className="h-20 w-20 flex-none sm:h-40 sm:w-40 rounded-lg
                                  bg-gray-100 border border-gray-300 hover:border-skyText overflow-hidden"
                                >
                                  <img
                                    src={item?.images[0]}
                                    alt="productImg"
